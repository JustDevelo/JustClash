...
**Лёгкий VPN-клиент для Windows и Android, оптимизированный под слабые устройства.**
...
JustClash — простой, быстрый VPN-клиент для Windows и Android. Работает на ядре **Mihomo (Clash.Meta)**, которое встроено в приложение.
...
- **arm64-v8a** — почти все современные телефоны. Сомневаетесь — *universal*
